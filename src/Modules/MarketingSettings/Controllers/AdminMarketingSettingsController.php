<?php namespace Eyeweb\MissionControl\Modules\MarketingSettings\Controllers;

use App\Http\Controllers\Controller;
use Eyeweb\MissionControl\Exports\PageMetaExport;
use Eyeweb\MissionControl\Imports\PageMetaImport;
use Maatwebsite\Excel\Facades\Excel;
use Eyeweb\MissionControl\Modules\MarketingSettings\Requests\MarketingSettingsRequest;
use Eyeweb\MissionControl\Modules\MarketingSettings\Repositories\MarketingSettingsRepository;

/**
 * Class AdminMarketingSettingsController
 * @package Eyeweb\MissionControl\Modules\MarketingSettings\Controllers
 */
