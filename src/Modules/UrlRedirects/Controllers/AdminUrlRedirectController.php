<?php namespace Eyeweb\MissionControl\Modules\UrlRedirects\Controllers;

use App\Http\Controllers\Controller;
use Maatwebsite\Excel\Facades\Excel;
use Eyeweb\MissionControl\Exports\UrlRedirectsExport;
use Eyeweb\MissionControl\Imports\UrlRedirectsImport;
use Eyeweb\MissionControl\Modules\UrlRedirects\Models\UrlRedirect;
use Eyeweb\MissionControl\Modules\UrlRedirects\Repositories\UrlRedirectRepository;
use Eyeweb\MissionControl\Modules\UrlRedirects\Requests\UrlRedirectRequest;

/**
 * Class AdminUrlRedirectController
 * @package Eyeweb\MissionControl\Modules\UrlRedirects\Controllers
 */
