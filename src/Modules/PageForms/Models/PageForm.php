<?php namespace Eyeweb\MissionControl\Modules\PageForms\Models;
...
/**
 * Class PageForm
 * @package Eyeweb\MissionControl\Modules\PageForms\Models
 */
class PageForm extends Eloquent
{
     ...
     * @var string
     */
    protected $presenter = '\Eyeweb\MissionControl\Modules\PageForms\Presenters\PageFormPresenter';
