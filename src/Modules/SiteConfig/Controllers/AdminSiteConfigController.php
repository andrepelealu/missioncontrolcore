<?php namespace Eyeweb\MissionControl\Modules\SiteConfig\Controllers;

use App\Http\Controllers\Controller;
use Eyeweb\MissionControl\Modules\EnvironmentVariables\Repositories\EnvironmentVariableRepository;
use Eyeweb\MissionControl\Modules\RobotsTxt\Repositories\RobotsTxtRepository;
use Eyeweb\MissionControl\Modules\Apis\Cloudflare\Facades\Cloudflare;
use File;
use Illuminate\Support\Facades\Artisan;

/**
 * Class AdminSiteConfigController
 * @package Eyeweb\MissionControl\Modules\SiteConfig\Controllers
 */
