...
use Eyeweb\MissionControl\Modules\MarketingSettings\Models\MarketingSetting;
...
class MissionControlServiceProvider extends ServiceProvider
{
    ...
    {
        // register providers
        $this->app->register('Eyeweb\MissionControl\Providers\MiddlewareServiceProvider');
        $this->app->register('Eyeweb\MissionControl\Providers\ComposerServiceProvider');
        $this->app->register('Eyeweb\MissionControl\Providers\ModuleServiceProvider');
        $this->app->register('Eyeweb\MissionControl\Providers\ConsoleServiceProvider');
        $this->app->register('Eyeweb\MissionControl\Providers\ValidatorServiceProvider');
        $this->app->register('Eyeweb\MissionControl\Providers\NewsletterServiceProvider');
        ...
        $this->app->register('Eyeweb\MissionControl\Modules\ImageResizer\ImageResizerServiceProvider');
        $this->app->register('Eyeweb\MissionControl\Modules\Cloudflare\CloudflareServiceProvider');
        ...
        $loader->alias('ImageResizer', 'Eyeweb\MissionControl\Modules\ImageResizer\Facades\ImageResizer');
        $loader->alias('Input', 'Illuminate\Support\Facades\Input');
        $loader->alias('Cloudflare', 'Eyeweb\MissionControl\Modules\Cloudflare\Facades\Cloudflare');
